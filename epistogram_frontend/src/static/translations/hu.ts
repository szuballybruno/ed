...
export const huTranslation: TranslationType = {
    ...
    data: {
        ...
        practiseQuestions: {
            ...
            noMoreQuestionsGoWatchVideosTwo: 'Jelenleg nincs több elérhető kérdés számodra.  Tekints meg videókat új kérdésekért, így pedig EpistoCoinjaidat is gyarapíthatod! ',
