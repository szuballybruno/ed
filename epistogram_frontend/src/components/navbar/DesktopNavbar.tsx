...
import {
    CurrentUserContext,
    RefetchUserAsyncContext,
} from '../system/AuthenticationFrame';
...
const DesktopNavbar = (props: {
    ...
    const [notificationsPopperOpen, setNotificationsPopperOpen] =
        useState(false);
    ...
    const userMenuItems = [
        {
            ...
            onClick: () =>
                navigate(
                    applicationRoutes.settingsRoute.preferencesRoute.route
                ),
        },
        {
            ...
            onClick: () =>
                navigate(
                    applicationRoutes.settingsRoute.featurePreviewRoute.route
                ),
        },
        {
            ...
            onClick: () =>
                navigate(
                    applicationRoutes.settingsRoute.developmentNotes.route
                ),
        },
        {
        ...
        >
            ...
            {!hideLinks && (
                <>
                    ...
                    ) : (isSmallerThan1180 && !showLogo) ||
                      (isSmallerThan1000 && showLogo) ? (
                        <Flex height="50px"
flex="1 0 600px">
                            {menuItems.map((item, index) => {
                                return (
                            ...
                            {currentCourseItemCode && (
                                <NavbarButton
                                    menuPath={getUrl(
                                        applicationRoutes.playerRoute.route,
                                        { itemCode: currentCourseItemCode }
                                    )}
                                >
                                    <EpistoButton
...
bgColor={'black'} />
                ...
                {user?.userActivity?.canAccessAdministration && (
                    <EpistoButton
                        variant={undefined}
                        onClick={() => {
                            navigate(
                                applicationRoutes.administrationRoute.homeRoute
                                    .overviewRoute.route
                            );
                        }}
                    >
