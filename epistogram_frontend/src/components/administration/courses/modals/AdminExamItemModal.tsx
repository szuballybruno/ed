...
import { Checkbox, Tab, Table, TableBody, TableCell, TableContainer, TableRow, Tabs } from "@mui/material"
...
import { AdminExamQuestionsModalPage } from "./AdminExamQuestionsModalPage"
...
export const AdminExamItemModal = (props: {
    ...
    const moreInfoDialogTabs = [
        {
            title: "Kérdések",
            component: <AdminExamQuestionsModalPage />
        },
        {
            title: "Statisztika",
                ...
                <Flex align="center">
                    <Flex h="50px" direction="column" mr="20px">
                        <EpistoFont fontSize={"fontLarge"} style={{
                            ...
                            Grafikai elemek témazáró
                            <ChipSmall text="Vizsga" color="var(--intenseYellow)" style={{
                                marginLeft: 15
                            }} />
                        </EpistoFont>
