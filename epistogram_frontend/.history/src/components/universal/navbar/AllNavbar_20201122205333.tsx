        ...
        <div className={classes.navbarButtonWrapper}>
            ...
            {!props.showLastButton ?
                <NavbarButton className={classes.lastItem}
                              key={4} index={4}
                              menuName={user.user.userData.currentCourse.name.get() ? user.user.userData.currentCourse.name.get()  : props.menuItems.lastItem.menuName}
                              menuPath={user.user.userData.currentCourse.name.get() ? '/cybersecurity-kurzus' : '/kurzusok'}
                              showImage={true}/>
             : null}
