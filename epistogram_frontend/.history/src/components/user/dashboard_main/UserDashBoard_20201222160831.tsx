...
import AdminDashboardHeader from '../../admin/universal/adminDashboardHeader/AdminDashboardHeader';
        ...
        <div className={classes.dashBoardMainContainer}>
            ...
            <div className={classes.dashboardRightColumn}>
                ...
                <div className={classes.dashboardLeftColumn}>
                    <AdminDashboardHeader titleText="Cikkek" showAddButton={false} addButtonText="" addButtonFunction={() => {}} linkPath="" />
                    <Articles />
                    <Votes />
                    <RecommendedCourses />
                </div>
