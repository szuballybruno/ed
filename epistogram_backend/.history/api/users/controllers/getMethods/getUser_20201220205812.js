...
const getUser = (req, res, next) => {
    const fetchData = async () => {
        ...
        const unfilteredFavoriteCourses = await fetchFavoriteCourses()
        const favoriteCourses = unfilteredFavoriteCourses.filter(function (el) {
            return el != null;
        });
        ...
        const unfilteredRecommendedCourses = await fetchRecommendedCourses()
        const recommendedCourses = unfilteredRecommendedCourses.filter(function (el) {
            return el != null;
        });
        ...
        let data = {
            userData: {
                ...
                doneCoursesCount: 0,  //Object, ami tartalmazza a kurzus szükséges! adatait
                doneExams: doneExams,
                doneExamsCount: 0,
