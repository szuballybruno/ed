...
export const getUserDataAsync = async (userId: IdType) => {
...
export interface AllowedMachinesAtHome {
    ipAddress: string;
}
...
export interface RecommendedCours {
    _id: string;
    name: string;
    thumbnailUrl: string;
    tags: string[];
...
export interface UserData {
    ...
    tasks: Task[];
    notes: Note[];
    allowedMachinesAtHome: AllowedMachinesAtHome[];
    badges: string[];
    ...
    doneCourses: any[];
    favoriteCourses: any[];
    recommendedCourses: RecommendedCours[];
    watchedVideosCount: string;
}
