...
export const instatiateServices = (singletonProvider: ServiceProvider): ServiceProvider => {
    ...
    const examService = new ExamService(userCourseBridgeService, ormConnectionService, userSessionActivityService, questionAnswerService, questionService, mapperService, loggerService);
    ...
    const moduleService = new ModuleService(ormConnectionService, mapperService, courseItemService, versionSaveService, fileService);
    ...
    const tempomatService = new TempomatService(ormConnectionService, loggerService, eventService);
    const pretestService = new PretestService(ormConnectionService, mapperService, examService, userCourseBridgeService, questionAnswerService, tempomatService);
