...
export const instatiateServices = (singletonProvider: ServiceProvider): ServiceProvider => {
    ...
    const questionAnswerService = new QuestionAnswerService(ormConnectionService, sqlFunctionService, coinAcquireService, versionSaveService);
    ...
    const userCourseBridgeService = new UserCourseBridgeService(ormConnectionService, mapperService, authorizationService);
