...
(
	SELECT
		...
		msr.maximum_success_rate correct_answer_rate,
	...
	LEFT JOIN maximum_success_rate msr
	ON msr.user_id = ucb.user_id
    AND msr.exam_version_id = civ.exam_version_id
