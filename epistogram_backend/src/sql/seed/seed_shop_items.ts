...
import seed_shop_item_categories from './seed_shop_item_categories';
import seed_storage_file from './seed_storage_file';

const list = getSeedList<ShopItem>()({
    ...
    shop_item_12: {
        ...
        coinPrice: 500,
        currencyPrice: 0,
        shopItemCategoryId: seed_shop_item_categories.shop_item_category_2.id,
        coverFileId: seed_storage_file.storage_file_521.id,
        courseId: null,
    ...
    shop_item_13: {
        ...
        currencyPrice: 0,
        shopItemCategoryId: seed_shop_item_categories.shop_item_category_2.id,
        coverFileId: seed_storage_file.storage_file_522.id,
        courseId: null,
        discountCodesId: null
    },
    shop_item_15: {
        ...
        coinPrice: 990,
        currencyPrice: 0,
        shopItemCategoryId: seed_shop_item_categories.shop_item_category_6.id,
        coverFileId: seed_storage_file.storage_file_523.id,
        courseId: null,
        discountCodesId: null
    },
    shop_item_16: {
        ...
        currencyPrice: 0,
        shopItemCategoryId: seed_shop_item_categories.shop_item_category_6.id,
        coverFileId: seed_storage_file.storage_file_524.id,
        courseId: null,
        discountCodesId: null
    },
    shop_item_14: {
        ...
        currencyPrice: 0,
        shopItemCategoryId: seed_shop_item_categories.shop_item_category_2.id,
        coverFileId: seed_storage_file.storage_file_525.id,
        courseId: null,
        discountCodesId: null
    },
    shop_item_17: {
        ...
        coinPrice: 499,
        currencyPrice: 0,
        shopItemCategoryId: seed_shop_item_categories.shop_item_category_3.id,
        coverFileId: seed_storage_file.storage_file_526.id,
        courseId: null,
        discountCodesId: null
    },
    shop_item_18: {
        ...
        currencyPrice: 0,
        shopItemCategoryId: seed_shop_item_categories.shop_item_category_6.id,
        coverFileId: seed_storage_file.storage_file_527.id,
        courseId: null,
        discountCodesId: null
    }
});
