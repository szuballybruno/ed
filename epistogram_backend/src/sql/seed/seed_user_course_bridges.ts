...
export const getUserCourseBridgeSeedData = (users: UserSeedDataType, courses: CourseSeedDataType, videos: VideoSeedDataType) => getSeedList<UserCourseBridge>()({
    ...
    user_course_bridge_1: {
        ...
        courseMode: 'advanced',
        currentItemCode: getItemCode(videos.video_132.id, 'video'),
        isCurrent: true,
    ...
    user_course_bridge_2: {
        ...
        courseMode: 'advanced',
        currentItemCode: getItemCode(videos.video_367.id, 'video'),
        isCurrent: true,
