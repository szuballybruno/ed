...
INSERT INTO public.course 
    (id, title, category_id, sub_category_id, teacher_id, cover_file_id)
VALUES
    (1, 'Webfejlesztés kezdőknek (HTML, CSS, BOOTSTRAP)', 1, 2, 1, 1),
    (2, 'Java programozás mesterkurzus', 1, 3, 1, 2),
    (3, 'Angular - Minden amire szükséged lehet', 1, 4, 1, 3),
    (4, 'Microsoft Excel Mesterkurzus', 1, 5, 1, 4)
