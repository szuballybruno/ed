...
export const huTranslation = getTranslation({
    ...
    data: {
        ...
        homePage: {
            ...
            availableCoursesLinkTitle: 'Kereső',
        ...
        routeTitles: {
            ...
            homePage: 'Kezdőlap',
            shopPage: 'Bolt',
            availableCourses: 'Kereső',
            leaderboard: 'Top tanulók',
            myProgress: 'Aktivitásom',
        ...
        practiseQuestions: {
            ...
            noMoreQuestionsGoWatchVideosButton: 'Irány a Kereső!',
        ...
        shop: {
            ...
            purchaseConfirmationDialog: {
                ...
                canBeFoundInTheCourseSearch: 'Mostantól megtalálhatod a Keresőben is!',
