...
import { ActivationCodeListDTO, CourseAdminListItemDTO, QuestionModuleCompareDTO } from '@episto/communication';
...
import { CourseStatDTO } from '@episto/communication';
...
import { ExamResultQuestionDTO } from '@episto/communication';
...
import { ResultAnswerDTO } from '@episto/communication';
    ...
    epistoMappingsBuilder
        .addMapping(CourseDetailsEditDataDTO, ([urlService]) => (view: CourseAdminDetailedView, categories: CourseCategory[], teachers: User[]) => {
            ...
            return instantiate<CourseDetailsEditDataDTO>({
                ...
                isPrequizRequired: view.isPrequizRequired,
                isPretestRequired: view.isPretestRequired,
