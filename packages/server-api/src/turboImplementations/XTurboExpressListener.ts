import { DomainProviderService, LoggerService } from '@episto/server-services';
import bodyParser from 'body-parser';
import express, { Application, Request, Response } from 'express';
import fileUpload from 'express-fileupload';
import { getCORSMiddleware } from '../CORSMiddleware';
import { ServiceProviderInitializator } from '../startup/initApp';
import { respondError } from '../startup/initTurboExpressListener';
import { ITurboRequest, ITurboResponse, IXTurboExpressListener, RegisterEndpointOptsType } from '../XTurboExpress/XTurboExpressTypes';
