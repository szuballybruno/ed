SELECT 
	...
	sq.start_date + (INTERVAL '1' day * sq.original_estimated_length_days) previsioned_completion_date,
	GREATEST(0, sq.original_estimated_length_days - sq.days_elapsed_since_start) remaining_days,
	CEIL(sq.total_item_count::numeric / sq.original_estimated_length_days) previsioned_items_per_day,
	CEIL(sq.total_item_count / sq.original_estimated_length_days::numeric * sq.days_elapsed_since_start) previsioned_items_completed_by_now,
	CEIL(100.0 / sq.original_estimated_length_days * sq.days_elapsed_since_start) previsioned_percent_completed_by_now,
...
(
	SELECT 
		...
		ucbv.original_estimated_length_days,
